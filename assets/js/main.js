...
// JSON-იდან მონაცემების წამოღება და HTML-ის გენერირება
fetch('data/gallery.json')
    ...
    .then(data => {
        ...
        data.forEach((item, index) => {
            ...
            slide.setAttribute('onclick', `openLightbox(${index})`);
...
// ამ ფუნქციას გარედან გამოვიძახებთ, ამიტომ window ობიექტს ვაბამთ
...
// ==========================================
// 📬 3. AJAX ფორმის გაგზავნის ძრავი (PHP)
// ==========================================
...
// ==========================================
// 🔓 5. ფუტერის სერვისების View More / Less მართვა
// ==========================================
function toggleFooterServices() {
    ...
    if (content.style.maxHeight && content.style.maxHeight !== '0px') {
        // თუ გახსნილია - ვხურავთ
        content.style.maxHeight = '0px';
        btnText.innerText = 'View All Services';
        btnIcon.style.transform = 'rotate(0deg)';
    } else {
        // თუ დაკეტილია - ვხსნით სრულ რეალურ სიმაღლეზე
        content.style.maxHeight = content.scrollHeight + "px";
        btnText.innerText = 'Show Less';
        btnIcon.style.transform = 'rotate(180deg)';
    }
}
window.toggleFooterServices = toggleFooterServices;


// ==========================================
// წლის ავტომატური განახლება
// ==========================================
